...
/**
 * Acceso directo a WhatsApp: pastilla oscura con filete dorado, en el registro
 * de la marca. Nada de burbujas verdes.
 */
export function WhatsAppFab({ href, label }: WhatsAppFabProps) {
  return (
    <a
      ...
      target="_blank"
      rel="noopener"
      className="border-gold/40 bg-forest-deep/90 text-gold-light hover:border-gold hover:text-cream fixed right-5 bottom-5 z-50 flex items-center gap-2.5 border px-4 py-3 backdrop-blur-lg transition-colors sm:right-8 sm:bottom-8"
    >
